...
.. |commits-since| image:: https://img.shields.io/github/commits-since/maztohir/bigquery-sql-parser/v0.0.0.svg
    :alt: Commits since latest release
    :target: https://github.com/maztohir/bigquery-sql-parser/compare/v0.0.0...master
